...
public class GenreServiceTest {
  ...
  public void testFindAll() throws Exception {
    ...
    when(genreRepositoryMock.findAll(sort)).thenReturn(Arrays.asList(TestUtil.GENRES));
    
    List<Genre> genres = genreService.findAll();
    
    assertEquals("Genre list is of the wrong size: ", TestUtil.GENRES.length, genres.size());
