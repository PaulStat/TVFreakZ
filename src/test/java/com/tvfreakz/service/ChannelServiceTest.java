...
public class ChannelServiceTest {
    ...
    public void testFindAll() throws Exception {
        ...
        when(channelRepositoryMock.findAll(sort)).thenReturn(
                Arrays.asList(TestUtil.CHANNELS));

        List<Channel> channelList = channelService.findAll();

        assertEquals("Channel list is the wrong size: ",
                TestUtil.CHANNELS.length, channelList.size());
